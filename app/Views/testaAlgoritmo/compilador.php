...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">COMPILADOR</h1><br>
</div>
<hr />
<?= $this->endSection() ?>
...
<form class="row g-3 form_atividades" method="post" action="<?= base_url('inserirCompilador') ?>">
    <div class="col-md-6">
        <label for="compilador" class="form-label">OBS: As variáveis ​​precisam ter valores predefinidos, pois o compilador não recebe dados do usuário.</label><br>
        <textarea name="compilador" id="compilador" rows="10" cols="70" placeholder="Digite seu código C++ aqui..."></textarea><br>
    </div>
