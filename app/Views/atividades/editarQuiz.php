...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">EDITAR QUIZ</h1>
</div>
<?= $this->endSection() ?>
...
<form class="row g-3" method="post" action="<?= base_url('alterarQuiz/' . $quiz['id_quiz']) ?>" onsubmit="return validarFormulario()">

    <div class="col-md-12">
        <label class="form-label">1 – Como podemos definir um Algoritmo?</label><br>

        <div class="form-check">
            <input type="radio" name="quiz1" id="#" value="A" <?= $quiz['quiz1'] == 'A' ? 'checked' : '' ?>>
            <label>
        ...
        <div class="form-check">
            <input type="radio" name="quiz1" id="#" value="B" <?= $quiz['quiz1'] == 'B' ? 'checked' : '' ?>>
            <label>
        ...
        <div class="form-check">
            <input type="radio" name="quiz1" id="#" value="C" <?= $quiz['quiz1'] == 'C' ? 'checked' : '' ?>>
            <label>
        ...
        <div class="form-check">
            <input type="radio" name="quiz1" id="#" value="D" <?= $quiz['quiz1'] == 'D' ? 'checked' : '' ?>>
            <label>
    ...
    <div class="col-md-12">
        ...
        <div class="form-check">
            <input type="radio" name="quiz2" value="A" <?= $quiz['quiz2'] == 'A' ? 'checked' : '' ?>>
            <label>
                A. Inteiro, Temporal, Caractere, Double.
            </label>
        </div>
        <div class="form-check">
            <input type="radio" name="quiz2" value="B" <?= $quiz['quiz2'] == 'B' ? 'checked' : '' ?>>
            <label>
                B. Booleano, Real, Inteiro, Irracional.
            </label>
        </div>
        <div class="form-check">
            <input type="radio" name="quiz2" id="#" value="C" <?= $quiz['quiz2'] == 'C' ? 'checked' : '' ?>>
            <label>
                C. Inteiro, Booleano, Tipografia, Double.
            </label>
        </div>
        <div class="form-check">
            <input type="radio" name="quiz2" id="#" value="D" <?= $quiz['quiz2'] == 'D' ? 'checked' : '' ?>>
            <label>
    ...
    <div class="col-md-12">
        ...
        <div class="form-check">
            <input type="radio" name="quiz3" id="#" value="A" <?= $quiz['quiz3'] == 'A' ? 'checked' : '' ?>>
            <label>
                A. Verdadeiro, Duvidoso.
            </label>
        </div>
        <div class="form-check">
            <input type="radio" name="quiz3" id="#" value="B" <?= $quiz['quiz3'] == 'B' ? 'checked' : '' ?>>
            <label>
                B. Falso, Duvidoso, Verdadeiro.
            </label>
        </div>
        <div class="form-check">
            <input type="radio" name="quiz3" id="#" value="C" <?= $quiz['quiz3'] == 'C' ? 'checked' : '' ?>>
            <label>
                C. Verdadeiro, Errado.
            </label>
        </div>
        <div class="form-check">
            <input type="radio" name="quiz3" id="#" value="D" <?= $quiz['quiz3'] == 'D' ? 'checked' : '' ?>>
            <label>
                D. Verdadeiro, Falso.
            </label><br><br>
        </div>
    ...
    <div class="col-md-12">
        ...
        <div class="form-check">
            <input type="radio" name="quiz4" id="#" value="A" <?= $quiz['quiz4'] == 'A' ? 'checked' : '' ?>>
            <label>
                A. Valor matemático de Pi.
            </label>
        </div>
        <div class="form-check">
            <input type="radio" name="quiz4" id="#" value="B" <?= $quiz['quiz4'] == 'B' ? 'checked' : '' ?>>
            <label>
                B. Salário de um Funcionário.
            </label>
        </div>
        <div class="form-check">
            <input type="radio" name="quiz4" id="#" value="C" <?= $quiz['quiz4'] == 'C' ? 'checked' : '' ?>>
            <label>
                C. Valor da Temperatura no final de semana.
            </label>
        </div>
        <div class="form-check">
            <input type="radio" name="quiz4" id="#" value="D" <?= $quiz['quiz4'] == 'D' ? 'checked' : '' ?>>
            <label>
    ...
    <div class="col-md-12">
        ...
        <div class="form-check">
            <input type="radio" name="quiz5" id="#" value="A" <?= $quiz['quiz5'] == 'A' ? 'checked' : '' ?>>
            <label>
                A. nome Aluno, nota2, CEP, RuaNumero.
            </label>
        </div>
        <div class="form-check">
            <input type="radio" name="quiz5" id="#" value="B" <?= $quiz['quiz5'] == 'B' ? 'checked' : '' ?>>
            <label>
                B. AlunoNumero, nota00002, cep, ruaComNumeroDaCasa.
            </label>
        </div>
        <div class="form-check">
            <input type="radio" name="quiz5" id="#" value="C" <?= $quiz['quiz5'] == 'C' ? 'checked' : '' ?>>
            <label>
                C. nomeAluno, 2nota, CEP, RuAnUmErO.
            </label>
        </div>
        <div class="form-check">
            <input type="radio" name="quiz5" id="#" value="D" <?= $quiz['quiz5'] == 'D' ? 'checked' : '' ?>>
            <label>
    ...
    <div class="col-md-12">
        <label class="form-label">6 – O que é Compilação?</label><br> <!--correta C -->
        <div class="form-check">
            <input type="radio" name="quiz6" id="#" value="A" <?= $quiz['quiz6'] == 'A' ? 'checked' : '' ?>>
            <label>
                A. Organização do código-fonte em uma pasta contendo arquivos em ordem alfabética.
            </label>
        </div>
        <div class="form-check">
            <input type="radio" name="quiz6" id="#" value="B" <?= $quiz['quiz6'] == 'B' ? 'checked' : '' ?>>
            <label>
                B. Execução das instruções contidas em um script contendo o código-fonte, de forma sequencial.
            </label>
        </div>
        <div class="form-check">
            <input type="radio" name="quiz6" id="#" value="C" <?= $quiz['quiz6'] == 'C' ? 'checked' : '' ?>>
            <label>
        ...
        <div class="form-check">
            <input type="radio" name="quiz6" id="#" value="D" <?= $quiz['quiz6'] == 'D' ? 'checked' : '' ?>>
            <label>
    ...
    <div class="col-md-12">
        <label class="form-label">7 – Qual dos seguintes itens mostra um laço for (para) escrito corretamente?</label><br> <!--correta D -->
        <div class="form-check">
            <input type="radio" name="quiz7" id="#" value="A" <?= $quiz['quiz7'] == 'A' ? 'checked' : '' ?>>
            <label>
                A. para (con = 1; con < 10; con–) { instruções }.
                    </label>
        </div>
        <div class="form-check">
            <input type="radio" name="quiz7" id="#" value="B" <?= $quiz['quiz7'] == 'B' ? 'checked' : '' ?>>
            <label>
                B. para (con = 10; con >= 1; con++) { instruções }.
            </label>
        </div>
        <div class="form-check">
            <input type="radio" name="quiz7" id="#" value="C" <?= $quiz['quiz7'] == 'C' ? 'checked' : '' ?>>
            <label>
                C. para (con = 10; con < 10; con–) { instruções }.
                    </label>
        </div>
        <div class="form-check">
            <input type="radio" name="quiz7" id="#" value="D" <?= $quiz['quiz7'] == 'D' ? 'checked' : '' ?>>
            <label>
    ...
    <div class="col-md-12">
        ...
        <div class="form-check">
            <input type="radio" name="quiz8" id="#" value="A" <?= $quiz['quiz8'] == 'A' ? 'checked' : '' ?>>
            <label>
                A. Processo, Decisão, Repetição.
            </label>
        </div>
        <div class="form-check">
            <input type="radio" name="quiz8" id="#" value="B" <?= $quiz['quiz8'] == 'B' ? 'checked' : '' ?>>
            <label>
                B. Decisão, Processo, Entrada / Saída.
            </label>
        </div>
        <div class="form-check">
            <input type="radio" name="quiz8" id="#" value="C" <?= $quiz['quiz8'] == 'C' ? 'checked' : '' ?>>
            <label>
                C. Entrada / Saída, Repetição, Decisão.
            </label>
        </div>
        <div class="form-check">
            <input type="radio" name="quiz8" id="#" value="D" <?= $quiz['quiz8'] == 'D' ? 'checked' : '' ?>>
            <label>
    ...
    <div class="col-md-12">
        ...
        <div class="form-check">
            <input type="radio" name="quiz11" id="#" value="A" <?= $quiz['quiz11'] == 'A' ? 'checked' : '' ?>>
            <label>
                A. Calcular o resto de uma divisão inteira.
            </label>
        </div>
        <div class="form-check">
            <input type="radio" name="quiz11" id="#" value="B" <?= $quiz['quiz11'] == 'B' ? 'checked' : '' ?>>
            <label>
                B. Operador que realiza cálculo de porcentagens.
            </label>
        </div>
        <div class="form-check">
            <input type="radio" name="quiz11" id="#" value="C" <?= $quiz['quiz11'] == 'C' ? 'checked' : '' ?>>
            <label>
                C. Retornar o módulo matemático (valor absoluto).
            </label>
        </div>
        <div class="form-check">
            <input type="radio" name="quiz11" id="#" value="D" <?= $quiz['quiz11'] == 'D' ? 'checked' : '' ?>>
            <label>
    ...
    <div class="col-md-12">
        ...
        <div class="form-check">
            <input type="radio" name="quiz12" id="#" value="A" <?= $quiz['quiz12'] == 'A' ? 'checked' : '' ?>>
            <label>
        ...
        <div class="form-check">
            <input type="radio" name="quiz12" id="#" value="B" <?= $quiz['quiz12'] == 'B' ? 'checked' : '' ?>>
            <label>
        ...
        <div class="form-check">
            <input type="radio" name="quiz12" id="#" value="C" <?= $quiz['quiz12'] == 'C' ? 'checked' : '' ?>>
            <label>
        ...
        <div class="form-check">
            <input type="radio" name="quiz12" id="#" value="D" <?= $quiz['quiz12'] == 'D' ? 'checked' : '' ?>>
            <label>
    ...
    <div class="col-md-12">
        ...
        <div class="form-check">
            <input type="radio" name="quiz13" id="#" value="A" <?= $quiz['quiz13'] == 'A' ? 'checked' : '' ?>>
            <label>
                A. +.
            </label>
        </div>
        <div class="form-check">
            <input type="radio" name="quiz13" id="#" value="B" <?= $quiz['quiz13'] == 'B' ? 'checked' : '' ?>>
            <label>
                B. *.
            </label>
        </div>
        <div class="form-check">
            <input type="radio" name="quiz13" id="#" value="C" <?= $quiz['quiz13'] == 'C' ? 'checked' : '' ?>>
            <label>
                C. ->.
            </label>
        </div>
        <div class="form-check">
            <input type="radio" name="quiz13" id="#" value="D" <?= $quiz['quiz13'] == 'D' ? 'checked' : '' ?>>
            <label>
                D. ;.
            </label><br><br>
        </div>
    ...
    <div class="col-md-12">
        <label class="form-label">14 – Observe o fluxograma a seguir e responda:</label><br> <!--correta D -->
        ...
        <div class="form-check">
            <input type="radio" name="quiz14" id="#" value="A" <?= $quiz['quiz14'] == 'A' ? 'checked' : '' ?>>
            <label>
                A. Decisão Condicional Simples.
            </label>
        </div>
        <div class="form-check">
            <input type="radio" name="quiz14" id="#" value="B" <?= $quiz['quiz14'] == 'B' ? 'checked' : '' ?>>
            <label>
                B. Decisão Condicional Encadeada.
            </label>
        </div>
        <div class="form-check">
            <input type="radio" name="quiz14" id="#" value="C" <?= $quiz['quiz14'] == 'C' ? 'checked' : '' ?>>
            <label>
                C. Decisão Condicional Complexa.
            </label>
        </div>
        <div class="form-check">
            <input type="radio" name="quiz14" id="#" value="D" <?= $quiz['quiz14'] == 'D' ? 'checked' : '' ?>>
            <label>
    ...
    <div class="col-md-12">
        <label class="form-label">15 – Para que serve uma biblioteca?</label><br> <!--correta C -->
        <div class="form-check">
            <input type="radio" name="quiz15" id="#" value="A" <?= $quiz['quiz15'] == 'A' ? 'checked' : '' ?>>
            <label>
                A. Para que os programadores possam consultar a documentação da linguagem com facilidade.
            </label>
        </div>
        <div class="form-check">
            <input type="radio" name="quiz15" id="#" value="B" <?= $quiz['quiz15'] == 'B' ? 'checked' : '' ?>>
            <label>
                B. Uma biblioteca é um programa que permite escrever e testar código-fonte, também conhecida como IDE.
            </label>
        </div>
        <div class="form-check">
            <input type="radio" name="quiz15" id="#" value="C" <?= $quiz['quiz15'] == 'C' ? 'checked' : '' ?>>
            <label>
                C. Uma biblioteca é um arquivo que organiza código pré-definido para o uso em aplicações.
            </label>
        </div>
        <div class="form-check">
            <input type="radio" name="quiz15" id="#" value="D" <?= $quiz['quiz15'] == 'D' ? 'checked' : '' ?>>
            <label>
