        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
            <div class="card-body p-0">
                ...
                <div class="row justify-content-center">
                    <!-- <div class="col-lg-5 d-none d-lg-block"> <img src="<?=base_url('img/logo.png')?>" alt=""></div> -->
                    <div class="col-lg-10">
                        <div class="p-5">
                            <div class="text-center ">
                                <h1 class="h4 text-gray-900 mb-4">Criar Conta</h1>
                            </div>
                            <form class="user"  method="post" action="<?= base_url('novousuario') ?>" >
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" id="exampleFirstName"
                                            placeholder="Primeiro Nome" name="primeiro_nome">
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-user" id="exampleLastName"
                                            placeholder="Ultimo Nome" name="ultimo_nome">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <input type="email" class="form-control form-control-user" id="exampleInputEmail"
                                        placeholder="Endereço de Email" name="email_user">
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <div class="text-center">
                                <a class="small" href="<?=base_url('/')?>">Já tem uma conta? Conecte-se!</a>
                            </div>
                        </div>
                    </div>
                </div>
